...
def main():
    ...
    exp_name = exp_name + "_AE_" + config["audio_encoder_args"]["model"] + "_TE_" + config["text_encoder_args"]["type"] + f"_lr_{args.lr}_seed_{seed}"
