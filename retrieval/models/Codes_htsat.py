...
# The Core of HTSAT
class Codec_Swin_Transformer(nn.Module):
    ...
    def __init__(self, spec_size=256, patch_size=4, patch_stride=(4, 4),
        ...
        super(Codec_Swin_Transformer, self).__init__()
    ...
    def forward(self, input: torch.Tensor, infer_mode=False):  # out_feat_keys: List[str] = None):
        ...
        x = input.transpose(2, 3) # resulting -> (batch_size, 1, frames, N_codes(*8))
